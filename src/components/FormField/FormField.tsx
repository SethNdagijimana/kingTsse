...
const FormField: FC<FormFieldProps> = ({
  ...
  return (
    <div
      className={cn(
        `border border-white p-[10px] rounded-md bg-white cursor-pointer transition-all duration-200 ease-in-out`,
        isFocused && ` ring-2 ring-[#b399ff80] ${style.inputBorder}`,
        className
      )}
      onClick={() => inputRef.current?.focus()}
    >
      <label className="text-[#949494] text-sm select-none">{label}</label>
